    ...
    <div className="mx-auto max-w-2xl space-y-8">
      ...
      <section className="rounded-2xl border border-brand-200 bg-white p-6 shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <span
            className={`inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-medium ${
              aiConfigured ? "bg-brand-50 text-brand-700" : "bg-slate-100 text-slate-500"
            }`}
          >
            <span
              className={`h-2 w-2 rounded-full ${
        ...
        <div className="mt-4 rounded-lg bg-brand-50 p-3 text-xs text-slate-600">
          <p className="font-medium text-brand-700">取得方法</p>
      ...
      <section className="rounded-2xl border border-brand-200 bg-brand-50 p-6">
        <h2 className="font-semibold text-brand-700">セットアップ手順</h2>
